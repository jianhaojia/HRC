...
// 自定义序列化器，用于将时间戳格式化为指定格式
class TimestampSerializer extends com.fasterxml.jackson.databind.JsonSerializer<Long> {
...
public class PackagingMachineDataGenerator {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        FileWriter fileWriter = new FileWriter("machine_data.txt", true);
